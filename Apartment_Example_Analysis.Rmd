...
```{r}
leaflet_plot(Apartments2, subject_lat, subject_lng)
```
...
```{r}
subj_cluster <- get_subj_cluster(sales_with_knn, subject_apn)
...
### NN summary stats
```{r}
sales_nn <- get_nn(sales_with_knn, subject_apn)
